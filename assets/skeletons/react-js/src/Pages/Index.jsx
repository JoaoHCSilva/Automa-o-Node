        ...
        {[
          {
            icon: "⚡",
            title: "Vite",
            desc: "Build ultrarrápido com Hot Module Replacement para desenvolvimento ágil.",
          },
          {
            icon: "🔗",
            title: "Inertia.js",
            desc: "SPA moderna sem API — o servidor controla a navegação, o cliente renderiza.",
          },
          {
            icon: "⚛️",
            title: "React",
            desc: "Biblioteca declarativa com hooks, component-based architecture e ecossistema vasto.",
          },
          {
            icon: "🚀",
            title: "Express",
            desc: "Framework minimalista e flexível para Node.js, rápido e descomplicado.",
          },
        ].map((f) => (
