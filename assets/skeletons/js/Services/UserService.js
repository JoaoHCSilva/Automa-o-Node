// UserService.js — Camada de lógica de negócio para usuários
...
class UserService {
    ...
    async getAllUsers() {
        try {
            ...
            return { success: false, message: 'Erro ao buscar usuarios', error: error.message };
        }
    }
    ...
    async getUserById(id) {
        try {
            ...
            return { success: false, message: 'Erro ao buscar usuario', error: error.message };
        }
    }
    ...
    async createUser(data) {
        try {
            if (!data.name || !data.email) {
                return { success: false, message: 'Nome e email sao obrigatorios' };
            }
            ...
            return { success: true, message: 'Usuario criado com sucesso', data: user };
        } catch (error) {
            return { success: false, message: 'Erro ao criar usuario', error: error.message };
        }
    }
    ...
    async updateUser(id, data) {
        try {
            ...
            return { success: true, message: 'Usuario atualizado com sucesso', data: user };
        } catch (error) {
            return { success: false, message: 'Erro ao atualizar usuario', error: error.message };
        }
    }
    ...
    async deleteUser(id) {
        try {
            ...
            return { success: false, message: 'Erro ao remover usuario', error: error.message };
        }
    }
}
